...
<!-- Mirrored from devscriptpro.com/themeforest/businesio/businesio/index14-color7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2020 07:30:28 GMT -->
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title> Qynex Technologies - Web Development | Mobile App Development</title>
    <!-- favicon -->
...
<body class="index3 index7 index-color7">
                ...
                <div class="col-lg-12 p-0">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html">
                            ...
                            <span class="loading" data-name="Loading">Qynex</span>
                        </a>
                        ...
                        <div class="collapse navbar-collapse" id="mainmenu">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#project-gallery">Portfolio</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 order-first order-lg-last">
                                        <div class="layer-4">
                                            <div class="right-img">
                                                <img class="img-fluid full-img" src="{{ asset('images/heroarea/one/full.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 order-first">
                                        <div class="layer-4">
                                            <div class="right-img">
                                                <img class="img-fluid full-img" src="{{ asset('images/heroarea/two/full.png') }}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 d-flex align-self-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 d-flex align-self-center">
                    <div class="info">
                        <h2 class="info-title">Our Company have Business 30 years Over. We Get <span>50+ Award.</span></h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem officiis illo aspernatur
                            debitis sit qui necessitatibus.
                            Aperiam quae repellendus perspiciatis? Optio assumenda reprehenderit quisquam ad!
                        </p>

                        <p>
                            Facere aliquam optio necessitatibus, unde ullam esse at aperiam neque minima asperiores
                            eligendi quisquam? Optio
                            assumenda
                            reprehenderit quisquam recusandae ratione et sunt impedit ad! ipsum dolor.</p>
                        <div class="link">
                            <a href="#" class="mybtn1">Learn More<i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row project-gallery-item">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-1 cat-3">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/7.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/7.jpg') }}">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item  cat-3 cat-4">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/1.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/1.jpg') }}">
                                                    <i class="fas fa-long-arrow-alt-right"></i>
                                                </a>
                                            </div>
                                            <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-2 cat-1">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/2.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/2.jpg') }}">
                                                    <i class="fas fa-long-arrow-alt-right"></i>
                                                </a>
                                            </div>
                                            <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-1 cat-3">
                                <div class="gallery-item-content">
                                    <div class="item-thumbnail">
                                        <img src="{{ asset('images/work/9.jpg') }}" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a class="img-popup image-preview" href="{{ asset('images/work/9.jpg') }}">
                                                        <i class="fas fa-long-arrow-alt-right"></i>
                                                    </a>
                                                </div>
                                                <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-3 cat-4">
                                <div class="gallery-item-content">
                                    <div class="item-thumbnail">
                                        <img src="{{ asset('images/work/5.jpg') }}" alt="">
                                        <div class="content-overlay">
                                            <div class="content">
                                                <div class="links">
                                                    <a class="img-popup image-preview" href="{{ asset('images/work/5.jpg') }}">
                                                        <i class="fas fa-long-arrow-alt-right"></i>
                                                    </a>
                                                </div>
                                                <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-1 cat-2">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/3.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/3.jpg') }}">
                                                    <i class="fas fa-long-arrow-alt-right"></i>
                                                </a>
                                            </div>
                                            <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-4 cat-2">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/4.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/4.jpg') }}">
                                                    <i class="fas fa-long-arrow-alt-right"></i>
                                                </a>
                                            </div>
                                            <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-3 cat-2">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/6.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/6.jpg') }}">
                                                    <i class="fas fa-long-arrow-alt-right"></i>
                                                </a>
                                            </div>
                                            <div class="info">
                        ...
                        <div class="mix col-md-6 col-lg-4 gallery-item cat-3 cat-1">
                            <div class="gallery-item-content">
                                <div class="item-thumbnail">
                                    <img src="{{ asset('images/work/8.jpg') }}" alt="">
                                    <div class="content-overlay">
                                        <div class="content">
                                            <div class="links">
                                                <a class="img-popup image-preview" href="{{ asset('images/work/8.jpg') }}">
                                                    <i class="fas fa-long-arrow-alt-right"></i>
                                                </a>
                                            </div>
                                            <div class="info">
                ...
                <div class="col-md-10 col-lg-9">
                    <div class="testimonial-slider">
                        <div class="item">
                            <div class="client">
                                <div class="client-image">
                                    <img src="{{ asset('images/testimonialimage/1.jpg') }}" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="item">
                            <div class="client">
                                <div class="client-image">
                                    <img src="{{ asset('images/testimonialimage/2.jpg') }}" class="img-fluid" alt="">
                                </div>
                                <p class="client-say">Contrary to popular belief, Lorem Ipsum is not simply random
                                    text. It has roots in a piece of classical Latin literature from 45 BC, making it
                                    over 2000 years old.Contrary to popular belief, Lorem Ipsum is not simply random
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                    <div class="section-title">
                        ...
                        <p>A perfect blend of creativity and technical wizardity.
                            The best people formula for great websites and applications!
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="team_slider">
                        <div class="team-member">
                            <div class="member-pic">
                                <img src="{{ asset('images/sahil.jpg') }}" alt="">
                            </div>
                            ...
                            <div class="member-data">
                                <div class="name">
                                    <h4 class="title">Sahilkhan Pathan</h4>
                        ...
                        <div class="team-member">
                            <div class="member-pic">
                                <img src="{{ asset('images/siddhu.jpg') }}" alt="">
                            </div>
                            ...
                            <div class="member-data">
                                <div class="name">
                                    <h4 class="title">Siddhant Laighe</h4>
                                    <p class="position">CEO &amp; Founder</p>
                                </div>
                            </div>
                        </div>
                        <div class="team-member">
                            <div class="member-pic">
                                <img src="{{ asset('images/amol.jpg') }} " alt="">
                            </div>
                            ...
                            <div class="member-data">
                                <div class="name">
                                    <h4 class="title">Amol Bhadane</h4>
                                    <p class="position">CEO &amp; Founder</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <div class="blog-slider">
                        <div class="item">
                            <div class="blog-box">
                                <div class="blog-images">
                                    <img src="{{ asset('images/news/1.jpg') }}" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="item">
                                <div class="blog-box">
                                    <div class="blog-images">
                                        <img src="{{ asset('images/news/2.jpg') }}" class="img-fluid" alt="">
                                    </div>
                                    <div class="blog-details">
                                        <ul class="post-meta-one">
                                            <li><a href="#"><i class="far fa-user"></i> John Doe </a></li>
                            ...
                            <div class="item">
                                    <div class="blog-box">
                                        <div class="blog-images">
                                            <img src="{{ asset('images/news/3.jpg') }}" class="img-fluid" alt="">
                                        </div>
                                        <div class="blog-details">
                                            <ul class="post-meta-one">
                                                <li><a href="#"><i class="far fa-user"></i> John Doe </a></li>
                                ...
                                <div class="item">
                                        <div class="blog-box">
                                            <div class="blog-images">
                                                <img src="{{ asset('images/news/4.jpg') }}" class="img-fluid" alt="">
                                            </div>
                                            <div class="blog-details">
                                                <ul class="post-meta-one">
                                                    <li><a href="#"><i class="far fa-user"></i> John Doe </a></li>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-8">
                    <div class="section-title">
                        ...
                        <p>One of our Product Managers will freely be in touch with you in the next
                    ...
                    <ul class="info-contact">
                        ...
                        <li>
                            <div class="info-box box2">
                                ...
                                <div class="right">
                                    <div class="content">
                                        <p>tpathan106@gmail.com</p>
                                        <p>laighesiddhant@gmail.com</p>
                                        <p>mr.amolbhadane@gmail.com</p>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="info-box box3">
                                ...
                                <div class="right">
                                    <div class="content">
                                        <p>Phase 3, Hinjewadi, Pune 411033</p>
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <div class="contact-form-wrapper">
                        <form id="contact-form" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="email" class="input-field borderd" id="email" placeholder="Enter Your Email"
                                        required>
                                </div>
                                <div class="col-12">
            ...
            <div class="row brand">
                <div class="col-12">
                    <div class="brand-slider">
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('images/technology/angular.png') }}" alt="">
                            </a>
                        </div>
                        
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('images/technology/android.png') }}" alt="">
                            </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/laravel.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/node.png') }}" alt="">
                                </a>
                        </div>
                        
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/wordpress.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/woocommerce.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/shopify.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/cake.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/asp.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/mean.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/reactnative.png') }}" alt="">
                                </a>
                        </div>
                        <div class="item">
                                <a href="#">
                                    <img src="{{ asset('images/technology/php.png') }}" alt="">
                                </a>
                        </div>
                        <!-- <div class="item">
                                <a href="#">
                                    <img src="{{ asset('') }}images/technology/vue.png" alt="">
                                </a>
                        </div>
                        <div class="item">
                            <a href="#">
                                <img src="{{ asset('') }}images/technology/react.png" alt="">
                            </a>
                        </div> -->
                    </div>
                </div>
    ...
    <footer class="footer" id="footer">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="footer-info-area">
                        ...
                        <div class="text">
                            <p>We are fully capable of satisfying client demands of higher flexibility with a bespoke engagement model.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                        <div class="footer-widget instagram-feed-widget">
                                ...
                                <ul class="instagram-feed-list">
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('images/instagram/1.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                                <img src="{{ asset('images/instagram/2.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                                <img src="{{ asset('images/instagram/3.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                                <img src="{{ asset('images/instagram/4.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                                <img src="{{ asset('images/instagram/5.png') }}" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                                <img src="{{ asset('images/instagram/6.png') }}" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="copy-bg text-center">
            <p>Copyright © 2020. All rights reserved by
                <a href="index.html">Qynex Technologies</a>
            </p>
        </div>
    </footer>
    <!-- Footer Section End -->
...
<!-- Mirrored from devscriptpro.com/themeforest/businesio/businesio/index14-color7.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Mar 2020 07:32:04 GMT -->
</html>